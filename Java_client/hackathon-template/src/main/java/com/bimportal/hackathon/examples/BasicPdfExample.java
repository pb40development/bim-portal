 ...
 * - Search for Domain Models and LOINs
 * - Export them as PDF files (may return ZIP if multiple PDFs)
    ...
    public static void demonstrateLoinPdfExport(EnhancedBimPortalClient client) {
        ...
        try {
            ...
            if (successfulExports > 0) {
                ...
                System.out.println("   📝 Note: API returns PDF for single documents, ZIP for multiple documents");
            }
