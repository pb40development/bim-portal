 ...
 * - Search for projects and LOINs
 * - Retrieve detailed information
 * - Perform basic exports
 */
        ...
        try {
            ...
            for (int i = 0; i < Math.min(3, loins.size()); i++) {
                ...
                System.out.println("   Visibility: " +
                        (loin.getVisibility() != null ? loin.getVisibility() : "N/A"));
            }
    ...
    public static void demonstrateBasicLoinIdsExport(EnhancedBimPortalClient client) {
        ...
        try {
            ...
            for (int i = 0; i < exportAttempts; i++) {
                ...
                System.out.println("   " + (i + 1) + ". " + loin.getName() + " (GUID: " + loin.getGuid() + ")");
            }
            ...
            for (int i = 0; i < exportAttempts; i++) {
                ...
                try {
                    ...
                    if (idsContent.isPresent()) {
                        ...
                        Optional<Path> savedPath = com.pb40.bimportal.util.ExportUtils.saveExportFile(content, filename);
                        ...
                        if (contentPreview.contains("<ids") || contentPreview.contains("Information Delivery Specification")) {
                            System.out.println("   🔍 Content appears to be valid IDS format");
                        } else {
                            System.out.println("   ⚠️ Content format unclear (first 200 chars): " +
                        ...
                        System.out.println("   💡 This LOIN may not have IDS export capabilities or may require special permissions");
                    }
            ...
            if (successfulExports > 0) {
                ...
                System.out.println("   🔧 Try running other export formats (PDF, OpenOffice) to test basic export functionality");
            }
        ...
        try {
            ...
            if (exportableProject.isPresent()) {
                ...
                if (pdfContent.isPresent()) {
                    System.out.println("✅ PDF export successful (size: " + pdfContent.get().length + " bytes)");
                } else {
                ...
                if (odtContent.isPresent()) {
                    System.out.println("✅ OpenOffice export successful (size: " + odtContent.get().length + " bytes)");
                } else {
