...
public class PropertyDto {
  ...
  public static final String JSON_PROPERTY_RELATION_OF_THE_PROPERTY_IDENTIFIERS_IN_THE_INTERCONNECTED_DICTIONARIES = "relationOfThePropertyIdentifiersInTheInterconnectedDictionaries";
  private List<@Valid RelationOfThePropertyIdentifiersInTheInterconnectedDictionaries> relationOfThePropertyIdentifiersInTheInterconnectedDictionaries = new ArrayList<>();
  ...
  public static final String JSON_PROPERTY_SYMBOLS_OF_THE_PROPERTY_IN_A_GIVEN_PROPERTY_GROUP = "symbolsOfThePropertyInAGivenPropertyGroup";
  private List<@Valid SymbolsOfTheGivenPropertyGroupDto> symbolsOfThePropertyInAGivenPropertyGroup = new ArrayList<>();
  ...
  public static final String JSON_PROPERTY_PARAMETERS_OF_THE_DYNAMIC_PROPERTY = "parametersOfTheDynamicProperty";
  private List<@Valid PropertyOrGroupWithNamesInLanguage> parametersOfTheDynamicProperty = new ArrayList<>();

  public static final String JSON_PROPERTY_UNITS = "units";
  private List<String> units = new ArrayList<>();

  public static final String JSON_PROPERTY_NAMES_OF_THE_DEFINING_VALUES = "namesOfTheDefiningValues";
  ...
  public static final String JSON_PROPERTY_LIST_OF_POSSIBLE_VALUES_IN_LANGUAGE = "listOfPossibleValuesInLanguage";
  private List<@Valid ListOfPossibleValuesInLanguageDto> listOfPossibleValuesInLanguage = new ArrayList<>();
  ...
  public PropertyDto relationOfThePropertyIdentifiersInTheInterconnectedDictionaries(List<@Valid RelationOfThePropertyIdentifiersInTheInterconnectedDictionaries> relationOfThePropertyIdentifiersInTheInterconnectedDictionaries) {
    
    this.relationOfThePropertyIdentifiersInTheInterconnectedDictionaries = relationOfThePropertyIdentifiersInTheInterconnectedDictionaries;
    return this;
  }

  public PropertyDto addRelationOfThePropertyIdentifiersInTheInterconnectedDictionariesItem(RelationOfThePropertyIdentifiersInTheInterconnectedDictionaries relationOfThePropertyIdentifiersInTheInterconnectedDictionariesItem) {
    ...
    this.relationOfThePropertyIdentifiersInTheInterconnectedDictionaries.add(relationOfThePropertyIdentifiersInTheInterconnectedDictionariesItem);
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_OF_THE_PROPERTY_IDENTIFIERS_IN_THE_INTERCONNECTED_DICTIONARIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<@Valid RelationOfThePropertyIdentifiersInTheInterconnectedDictionaries> getRelationOfThePropertyIdentifiersInTheInterconnectedDictionaries() {
    return relationOfThePropertyIdentifiersInTheInterconnectedDictionaries;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_OF_THE_PROPERTY_IDENTIFIERS_IN_THE_INTERCONNECTED_DICTIONARIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationOfThePropertyIdentifiersInTheInterconnectedDictionaries(List<@Valid RelationOfThePropertyIdentifiersInTheInterconnectedDictionaries> relationOfThePropertyIdentifiersInTheInterconnectedDictionaries) {
    this.relationOfThePropertyIdentifiersInTheInterconnectedDictionaries = relationOfThePropertyIdentifiersInTheInterconnectedDictionaries;
  }
  ...
  public PropertyDto definitionsInLanguage(List<@Valid DefinitionsInLanguageDto> definitionsInLanguage) {
    
    this.definitionsInLanguage = definitionsInLanguage;
    return this;
  }

  public PropertyDto addDefinitionsInLanguageItem(DefinitionsInLanguageDto definitionsInLanguageItem) {
  ...
  public PropertyDto descriptionsInLanguage(List<@Valid DescriptionsInLanguageDto> descriptionsInLanguage) {
    
    this.descriptionsInLanguage = descriptionsInLanguage;
    return this;
  }

  public PropertyDto addDescriptionsInLanguageItem(DescriptionsInLanguageDto descriptionsInLanguageItem) {
  ...
  @JsonProperty(JSON_PROPERTY_DESCRIPTIONS_IN_LANGUAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDescriptionsInLanguage(List<@Valid DescriptionsInLanguageDto> descriptionsInLanguage) {
    this.descriptionsInLanguage = descriptionsInLanguage;
  }
  ...
  public PropertyDto connectedProperties(List<@Valid PropertyOrGroupWithNamesInLanguage> connectedProperties) {
    
    this.connectedProperties = connectedProperties;
    return this;
  }

  public PropertyDto addConnectedPropertiesItem(PropertyOrGroupWithNamesInLanguage connectedPropertiesItem) {
  ...
  @JsonProperty(JSON_PROPERTY_CONNECTED_PROPERTIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnectedProperties(List<@Valid PropertyOrGroupWithNamesInLanguage> connectedProperties) {
    this.connectedProperties = connectedProperties;
  }
  ...
  public PropertyDto symbolsOfThePropertyInAGivenPropertyGroup(List<@Valid SymbolsOfTheGivenPropertyGroupDto> symbolsOfThePropertyInAGivenPropertyGroup) {
    
    this.symbolsOfThePropertyInAGivenPropertyGroup = symbolsOfThePropertyInAGivenPropertyGroup;
    return this;
  }

  public PropertyDto addSymbolsOfThePropertyInAGivenPropertyGroupItem(SymbolsOfTheGivenPropertyGroupDto symbolsOfThePropertyInAGivenPropertyGroupItem) {
    if (this.symbolsOfThePropertyInAGivenPropertyGroup == null) {
      this.symbolsOfThePropertyInAGivenPropertyGroup = new ArrayList<>();
    }
    this.symbolsOfThePropertyInAGivenPropertyGroup.add(symbolsOfThePropertyInAGivenPropertyGroupItem);
    return this;
  }
  ...
  public List<@Valid SymbolsOfTheGivenPropertyGroupDto> getSymbolsOfThePropertyInAGivenPropertyGroup() {
    return symbolsOfThePropertyInAGivenPropertyGroup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SYMBOLS_OF_THE_PROPERTY_IN_A_GIVEN_PROPERTY_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSymbolsOfThePropertyInAGivenPropertyGroup(List<@Valid SymbolsOfTheGivenPropertyGroupDto> symbolsOfThePropertyInAGivenPropertyGroup) {
    this.symbolsOfThePropertyInAGivenPropertyGroup = symbolsOfThePropertyInAGivenPropertyGroup;
  }
  ...
  /**
   * Enthält die Dimension der Einheiten in der folgenden Reihenfolge: Länge, Masse, Zeit, Stoffmenge, Lichtstärke, Stromstärke, Temperatur
   * @return dimension
   */
  @jakarta.annotation.Nullable
  ...
  public PropertyDto parametersOfTheDynamicProperty(List<@Valid PropertyOrGroupWithNamesInLanguage> parametersOfTheDynamicProperty) {
    
    this.parametersOfTheDynamicProperty = parametersOfTheDynamicProperty;
    return this;
  }

  public PropertyDto addParametersOfTheDynamicPropertyItem(PropertyOrGroupWithNamesInLanguage parametersOfTheDynamicPropertyItem) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETERS_OF_THE_DYNAMIC_PROPERTY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParametersOfTheDynamicProperty(List<@Valid PropertyOrGroupWithNamesInLanguage> parametersOfTheDynamicProperty) {
    this.parametersOfTheDynamicProperty = parametersOfTheDynamicProperty;
  }
  ...
  public PropertyDto namesOfTheDefiningValues(List<@Valid NamesInLanguage> namesOfTheDefiningValues) {
  ...
  public PropertyDto listOfPossibleValuesInLanguage(List<@Valid ListOfPossibleValuesInLanguageDto> listOfPossibleValuesInLanguage) {
    
    this.listOfPossibleValuesInLanguage = listOfPossibleValuesInLanguage;
    return this;
  }

  public PropertyDto addListOfPossibleValuesInLanguageItem(ListOfPossibleValuesInLanguageDto listOfPossibleValuesInLanguageItem) {
  ...
  @JsonProperty(JSON_PROPERTY_LIST_OF_POSSIBLE_VALUES_IN_LANGUAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setListOfPossibleValuesInLanguage(List<@Valid ListOfPossibleValuesInLanguageDto> listOfPossibleValuesInLanguage) {
    this.listOfPossibleValuesInLanguage = listOfPossibleValuesInLanguage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, propertyDto.id) &&
        ...
        Objects.equals(this.relationOfThePropertyIdentifiersInTheInterconnectedDictionaries, propertyDto.relationOfThePropertyIdentifiersInTheInterconnectedDictionaries) &&
        ...
        Objects.equals(this.symbolsOfThePropertyInAGivenPropertyGroup, propertyDto.symbolsOfThePropertyInAGivenPropertyGroup) &&
        ...
        Objects.equals(this.parametersOfTheDynamicProperty, propertyDto.parametersOfTheDynamicProperty) &&
        ...
        Objects.equals(this.listOfPossibleValuesInLanguage, propertyDto.listOfPossibleValuesInLanguage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, guid, status, dateOfCreation, dateOfActivation, dateOfLastChange, dateOfRevision, dateOfVersion, dateOfDeactivation, versionNumber, revisionNumber, replaces, replacedBy, deprecationExplanation, relationOfThePropertyIdentifiersInTheInterconnectedDictionaries, catalogInformation, creatorsLanguage, namesInLanguage, definitionsInLanguage, descriptionsInLanguage, examplesInLanguage, connectedProperties, groupOfProperties, symbolsOfThePropertyInAGivenPropertyGroup, visualRepresentation, countryOfUse, subdivisionOfUse, countryOfOrigin, physicalQuantity, dimension, methodOfMeasurement, dataType, dynamicProperty, parametersOfTheDynamicProperty, units, namesOfTheDefiningValues, definingValues, tolerance, digitalFormat, textFormat, listOfPossibleValuesInLanguage, boundaryValues, metadata, bookmarked, observed, organisationId, organisationName, tags, organisationType, canCreateNewVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("    relationOfThePropertyIdentifiersInTheInterconnectedDictionaries: ").append(toIndentedString(relationOfThePropertyIdentifiersInTheInterconnectedDictionaries)).append("\n");
    ...
    sb.append("    descriptionsInLanguage: ").append(toIndentedString(descriptionsInLanguage)).append("\n");
    sb.append("    examplesInLanguage: ").append(toIndentedString(examplesInLanguage)).append("\n");
    sb.append("    connectedProperties: ").append(toIndentedString(connectedProperties)).append("\n");
    sb.append("    groupOfProperties: ").append(toIndentedString(groupOfProperties)).append("\n");
    sb.append("    symbolsOfThePropertyInAGivenPropertyGroup: ").append(toIndentedString(symbolsOfThePropertyInAGivenPropertyGroup)).append("\n");
    ...
    sb.append("    parametersOfTheDynamicProperty: ").append(toIndentedString(parametersOfTheDynamicProperty)).append("\n");
    sb.append("    units: ").append(toIndentedString(units)).append("\n");
    sb.append("    namesOfTheDefiningValues: ").append(toIndentedString(namesOfTheDefiningValues)).append("\n");
    ...
    sb.append("    listOfPossibleValuesInLanguage: ").append(toIndentedString(listOfPossibleValuesInLanguage)).append("\n");
