    ...
    public Exception decode(String methodKey, Response response) {
        ...
        if (contentTypeHeaders != null && !contentTypeHeaders.isEmpty()) {
            ...
            if (contentType.contains("application/pdf") ||
                ...
                logger.debug("Error response has binary content type: {}, might be successful binary response misinterpreted as error", contentType);
                ...
                return new BinaryContentMisinterpretedException(
                        "Response appears to be binary content but was treated as error. Content-Type: " + contentType);
            }
        }
