...
public class AIATemplatePublicDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdDate, dateOfActivation, dateOfLastChange, dateOfRevision, dateOfVersion, dateOfDeactivation, guid, name, description, organisationId, organisationName, versionNumber, revisionNumber, buildNumber, exportFormats, templateType, chapters);
  }
