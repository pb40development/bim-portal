...
public class LOINPublicDto {
  ...
  public static final String JSON_PROPERTY_FALLBACK_PROPERTY_GROUP_NAME = "fallbackPropertyGroupName";
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdDate, dateOfActivation, dateOfLastChange, dateOfRevision, dateOfVersion, dateOfDeactivation, guid, name, description, organisationId, organisationName, versionNumber, revisionNumber, buildNumber, exportFormats, filters, objectTypes, dataFormats, properties, levelOfDetail, dimensionality, location, appearance, behaviour, geometricComment, documentations, fallbackPropertyGroupName, classifications, contexts);
  }
  ...
  public String toString() {
    ...
    sb.append("    fallbackPropertyGroupName: ").append(toIndentedString(fallbackPropertyGroupName)).append("\n");
