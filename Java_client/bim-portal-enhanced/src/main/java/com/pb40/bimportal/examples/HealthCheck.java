...
/**
 * Health check example to test BIM Portal API connectivity and authentication
 * This file should be placed in: bim-portal-enhanced/src/main/java/com/pb40/bimportal/examples/
 */
