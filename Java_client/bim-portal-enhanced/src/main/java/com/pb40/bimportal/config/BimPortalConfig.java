...
import com.pb40.bimportal.config.ConfigLoader;

/**
 * Centralized configuration for BIM Portal API enhanced client.
 *
 * This class provides configuration management for the enhanced client
 * that wraps the generated OpenAPI client code.
 */
public class BimPortalConfig {
    ...
    public static boolean hasCredentials() {
        return getUsername() != null && getPassword() != null
               && !getUsername().trim().isEmpty() && !getPassword().trim().isEmpty();
    }
