 ...
 *
 * This builder provides a fluent API for creating clients with various
 * configuration options while maintaining sensible defaults.
 */
public class BimPortalClientBuilder {
    ...
    private InfrastrukturApi createInfrastrukturApi() {
        return Feign.builder()
                ...
                .errorDecoder(new feign.codec.ErrorDecoder.Default() {
                    @Override
    ...
    private void validateConfiguration() {
        ...
        if (!useDefaultCredentials) {
            if (username == null || username.trim().isEmpty()) {
                throw new IllegalStateException("Username cannot be null or empty when using custom credentials");
            }
            if (password == null || password.trim().isEmpty()) {
                throw new IllegalStateException("Password cannot be null or empty when using custom credentials");
            }
        }
    }
